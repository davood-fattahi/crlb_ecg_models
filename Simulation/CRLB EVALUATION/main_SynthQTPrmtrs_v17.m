...
Qplb='[-5 0 Qt(j,1)]'; % optimization conditions: lower bound for the Q wave parameters
Qpub='[5 3*(Qt(j,3)-Qt(j,1)) Qt(j,3)]'; % optimization conditions: upper bound for the Q wave parameters
...
Tplb='[-5 0 Tt(j,1)]';% optimization conditions: lower bound for the T wave parameters
Tpub='[5 3*(Tt(j,3)-Tt(j,1)) Tt(j,3)]';% optimization conditions: upper bound for the T wave parameters

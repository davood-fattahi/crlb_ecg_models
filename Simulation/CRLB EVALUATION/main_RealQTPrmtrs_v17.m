...
for i=1:NumCases
    ...
    %% finding the beats with upward QRS and a normal T 
    ...
    for j=1:NumBeats  % for each beat ...
        ...
        [Q(ii,:),T(ii,:)] =QTfidapprox(AllBeats(ii,:), Rp(ii), Fs); % q and t waves peaks and bounderies
...
for k=1:length(SNRdB)
    for j=1:PriNumBeats
        ...
        [~, MlFINumT(:,:,j,k)]=GaussCrlbNumeric(tm(TSegOn(j):TSegOff(j)), PrParamsT(j,:), VarSigQ(j)/SNR(k), 1 );

        [~, MlFIApprQ(:,:,j,k)]=GaussCRLB(PrParamsQ(j,1), PrParamsQ(j,2), Fs, VarSigQ(j)/SNR(k) );
        [~, MlFIApprT(:,:,j,k)]=GaussCRLB(PrParamsT(j,1), PrParamsT(j,2), Fs, VarSigQ(j)/SNR(k) );
...
saveas(gcf,'Backup and Results\DetQ_RealData.fig')
saveas(gcf,'Backup and Results\DetQ_RealData.eps','epsc')
...
saveas(gcf,'Backup and Results\DetT_RealData.fig')
saveas(gcf,'Backup and Results\DetT_RealData.eps','epsc')
...
clear
load('Backup and Results\results heavy run\RealDataQT_Results.mat');
close all
beta=3;
...
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\QTintVarEr_RealData.fig')
saveas(gcf,'Backup and Results\QTintVarEr_RealData.eps','epsc')
...
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\QonVarEr_RealData.fig')
saveas(gcf,'Backup and Results\QonVarEr_RealData.eps','epsc')
...
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\ToffVarEr_RealData.fig')
saveas(gcf,'Backup and Results\ToffVarEr_RealData.eps','epsc')
...
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\QTintStdEr_RealData.fig')
saveas(gcf,'Backup and Results\QTintStdEr_RealData.eps','epsc')
...
legend('ML RMSE','ML CRLB^{1/2}',' BYS RMSE','BYS CRLB^{1/2}')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\QonStdEr_RealData.fig')
saveas(gcf,'Backup and Results\QonStdEr_RealData.eps','epsc')
...
legend('ML RMSE','ML CRLB^{1/2}',' BYS RMSE','BYS CRLB^{1/2}')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\ToffStdEr_RealData.fig')
saveas(gcf,'Backup and Results\ToffStdEr_RealData.eps','epsc')

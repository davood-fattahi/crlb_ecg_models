...
%     figure
%     plot(tm,signal+10^(-.5*(22/10))*std(signal)*randn(size(signal)))
%     xlabel 'time (sec)'; ylabel 'amplitude (mv)';
%     saveas(gcf,'Backup and Results\SynthEcgSample.fig')
%     saveas(gcf,'Backup and Results\SynthEcgSample.eps','epsc')
%     saveas(gcf,'Backup and Results\SynthEcgSample2.eps','eps')
...
for j=1:PriNumBeats  % for each beat ...
    ...
    tm=(1:StLngth)/SynthEcgFs; % time stamp; J point is the reference time (zero).        
...
% end
save('Backup and Results\SynthDataST_PriorSTPrmtrs.mat');
...
xlabel 'SNR (dB)'; ylabel 'Determinant (mV^4/Sec^2)';
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\DetSTparams_SynthData.fig')
saveas(gcf,'Backup and Results\DetSTparams_SynthData.eps','epsc')
...
xlabel 'SNR (dB)'; ylabel 'Error varinace (mV^2)';
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\STlevel_SynthData.fig')
saveas(gcf,'Backup and Results\STlevel_SynthData.eps','epsc')
...
xlabel 'SNR (dB)'; ylabel 'Error varinace (mV^2/Sec^2)';
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\STslope_SynthData.fig')
saveas(gcf,'Backup and Results\STslope_SynthData.eps','epsc')


save('Backup and Results\SynthDataST_Results.mat');

%% ST index error and CRLB
clear
load('Backup and Results\results heavy run\SynthDataST_Results.mat');
beta=1;
...
xlabel 'SNR (dB)'; ylabel 'Error varinace ((mv + mV/Sec)^2)';
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\STind_SynthData.fig')
saveas(gcf,'Backup and Results\STind_SynthData.eps','epsc')

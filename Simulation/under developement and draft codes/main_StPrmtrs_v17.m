...
beta=0.1; % ST slope coeff in ST index
...
save('Backup and Results\RealDataST_InitialPool.mat');
...
save('Backup and Results\RealDataST_PriorSTPrmtrs.mat');
...
saveas(gcf,'Backup and Results\DetSTparams_RealData.fig')
saveas(gcf,'Backup and Results\DetSTparams_RealData.eps','epsc')
...
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\STlevel_RealData.fig')
saveas(gcf,'Backup and Results\STlevel_RealData.eps','epsc')
...
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\STslope_RealData.fig')
saveas(gcf,'Backup and Results\STslope_RealData.eps','epsc')


save('Backup and Results\RealDataST_Results.mat');



%% ST index error and CRLB
clear
load('Backup and Results\results heavy run\RealDataST_Results.mat');
...
legend('ML MSE','ML CRLB',' BYS MSE','BYS CRLB')
% title 'Determinants of Error Cov. and CRLB matrices for Q wave Gaus. parameters'
saveas(gcf,'Backup and Results\STind_RealData.fig')
saveas(gcf,'Backup and Results\STind_RealData.eps','epsc')

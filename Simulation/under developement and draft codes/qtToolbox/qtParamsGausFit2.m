...
%%% sort Gaussians ...
a=GaussParams.q(1:3:end, :, :); b=GaussParams.q(2:3:end, :, :); c=GaussParams.q(3:3:end, :, :);
[c,I]=sort(c,1); a=a(I); b=b(I);
GaussParams.q(1:3:end, :, :)=a; GaussParams.q(2:3:end, :, :)=b; GaussParams.q(3:3:end, :, :)=c;

a=GaussParams.t(1:3:end, :, :); b=GaussParams.t(2:3:end, :, :); c=GaussParams.t(3:3:end, :, :);
[c,I]=sort(c,1); a=a(I); b=b(I);
GaussParams.t(1:3:end, :, :)=a; GaussParams.t(2:3:end, :, :)=b; GaussParams.t(3:3:end, :, :)=c;
